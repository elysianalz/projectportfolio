    ...
    <div class="row row-cols-auto g-4">
      ...
      <div class="col">
        <article class="card">
          <!-- <img src="..." class="card-img-top"> -->
          <div class="card-body d-flex flex-column">
            <h5 class="card-title ">Beautiful Weather Widget</h5>
            <p class="card-text">Floating desktop widget that will display the weather based on your location derived from your ip address</p>
            <a href="https://github.com/elysianalz/beautifulweather" class = "btn btn-primary mt-auto">visit project</a>
          </div>
        </article>
      </div>
